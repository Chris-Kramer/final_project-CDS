...
# Deviding the rapes by population and multiplies by 100 to get a factor of rape per person in procent. In order to du this we are dropping the municipality column
charged_popu <- char_rape[,2:12]/population[,2:12]*100
reported_popu <- rep_rape[,2:12]/population[,2:12]*100
...
```{r}
charged_reported_rape <- char_rape[,2:12]-rep_rape[,2:12]
